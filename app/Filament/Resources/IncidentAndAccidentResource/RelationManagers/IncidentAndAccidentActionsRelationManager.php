...
namespace App\Filament\Resources\IncidentAndAccidentResource\RelationManagers;
...
class IncidentAndAccidentActionsRelationManager extends RelationManager
{
            ...
            ->headerActions([
                Tables\Actions\Action::make('create')
                    ...
                    ->url(function () {
                        ...
                        $model = class_basename(IncidentAndAccident::class);

                        return IncidentAndAccidentResource::getUrl('action.create', [
                            'model_id' => $recordId,
                            'model' => $model,
                        ]);
                    }),
